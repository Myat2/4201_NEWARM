...
public class OmniTrackTrajectoryCommand extends CommandBase {
 ...
 RamseteCommand m_cm;
  ...
  public void initialize() {
    if (m_trajectory.get() == null) return;
  ...
  public void execute() {
    ...
    double targetXVel = vRef * poseError.getRotation().getCos();
    double targetYVel = vRef * poseError.getRotation().getSin();
...
//    return m_timer.hasElapsed(m_trajectory.get().getTotalTimeSeconds());
    if (m_trajectory.get() == null) return true;
