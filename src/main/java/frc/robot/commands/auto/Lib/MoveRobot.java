...
public class MoveRobot extends CommandBase
{
    ...
    protected double m_startSpeed, m_endSpeed, m_dist;
    ...
    public MoveRobot(int type, double dist, double startSpeed, double endSpeed, double maxSpeed)
    {
        ...
        m_dist = dist;
        if (type==2){
            m_constraints = new TrapezoidProfile.Constraints(maxSpeed, 0.8*Math.PI);
        }
        else{
            m_constraints = new TrapezoidProfile.Constraints(maxSpeed, 0.4);
        }
